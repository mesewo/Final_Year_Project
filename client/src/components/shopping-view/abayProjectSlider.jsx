...
export default function AbayProjectsSlider() {
  ...
  return (
    <section className="relative w-full max-w-7xl mx-auto my-16 rounded-3xl overflow-hidden bg-gradient-to-r from-blue-100 via-indigo-100 to-blue-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 shadow-[0_8px_32px_0_rgba(30,58,138,0.25)] dark:shadow-[0_8px_32px_0_rgba(30,41,59,0.35)] border-4 border-blue-300 dark:border-gray-700 transition-transform duration-300 hover:scale-[1.015] hover:shadow-[0_12px_48px_0_rgba(30,58,138,0.35)]">
      <div className="py-10 px-2 md:px-8">
        <h2
          className="text-2xl xs:text-3xl md:text-4xl font-extrabold text-center mb-8 bg-gradient-to-r from-blue-700 via-indigo-700 to-blue-400 dark:from-blue-300 dark:via-indigo-400 dark:to-blue-500 bg-clip-text text-transparent drop-shadow-lg"
          style={{
        ...
        >
          <button
            onClick={prev}
            className="text-blue-500 hover:text-blue-700 dark:text-blue-300 dark:hover:text-blue-400 bg-white/70 dark:bg-gray-800/80 rounded-full p-3 shadow transition"
            ...
            {projects.map((project, i) => (
              ...
              >
                <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 w-full justify-center animate-fade-in">
                  <div className="flex items-center justify-center bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-2 md:p-6 transition-transform duration-500 hover:scale-105">
                    <img
                      src={project.logo}
                      alt={project.name}
                  ...
                  <div className="text-center md:text-left max-w-lg">
                    <h3 className="text-xl xs:text-2xl md:text-3xl font-bold text-blue-900 dark:text-blue-200 mb-2 drop-shadow">
                      {project.name}
                    </h3>
                    <div className="text-base md:text-lg text-indigo-700 dark:text-indigo-300 font-semibold mb-3 italic">
                      {project.tagline}
                    </div>
                    <p className="text-base xs:text-lg md:text-xl text-blue-700 dark:text-blue-200 font-medium bg-blue-50 dark:bg-gray-800 rounded-lg px-4 py-2 inline-block shadow">
                      {project.fact}
                    </p>
                  </div>
                </div>
        ...
        <div className="mt-8 flex justify-center gap-2">
          {projects.map((_, i) => (
            <button
              ...
              ${
                idx === i
                  ? "bg-blue-700 dark:bg-blue-300 scale-110 shadow-[0_2px_8px_0_rgba(30,58,138,0.25)]"
                  : "bg-blue-300 dark:bg-gray-700 hover:bg-blue-500 dark:hover:bg-blue-400"
              }
            `}
