...
const DialogOverlay = React.forwardRef(({ className, blur = true, ...props }, ref) => (
  ...
  (
    {
      className,
      children,
      size = "default", // 'sm', 'default', 'lg', 'xl', 'full', 'custom'
      overlayClassName,
      hideClose = false,
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          size === "full" && "w-[95vw] h-[90vh] max-w-[95vw]",
          size === "custom" && "w-auto h-auto",
          className
        )}
        {...props}
      >
