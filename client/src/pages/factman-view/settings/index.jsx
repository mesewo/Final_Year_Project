...
} from "@/store/factman/settings-slice";
import { setUser } from "@/store/auth-slice"; // import this
import {
  Tabs,
  TabsContent,
  TabsList,
...
export default function FactmanSettings() {
  ...
  const handleChangeUsername = async () => {
    ...
    const res = await dispatch(updateFactmanUsername({ userId: user.id, newUsername: username }));
  ...
  const handleChangePassword = async () => {
    ...
    setIsChanging(true);
    try {
      await dispatch(updateFactmanPassword({ userId: user.id, newPassword })).unwrap();
